...
import com.fuliang.gank.callback.DragListener;
import com.fuliang.gank.callback.DragStateListener;
import com.fuliang.gank.transform.CompositeTransformation;
import com.fuliang.gank.transform.ElevationTransformation;
import com.fuliang.gank.transform.RootTransformation;
import com.fuliang.gank.transform.ScaleTransformation;
import com.fuliang.gank.transform.YTranslationTransformation;
import com.fuliang.gank.util.ActionBarToggleAdapter;
import com.fuliang.gank.util.DrawerListenerAdapter;
import com.fuliang.gank.util.HiddenMenuClickConsumer;
...
public class SlidingRootNavBuilder {
    ...
    private SlidingRootNavLayout newRoot;
    ...
    public SlidingRootNavBuilder hideMenu(){
        newRoot.closeMenu();
        return this;
    }
    ...
    public SlidingRootNav inject() {
        ...
        newRoot = createAndInitNewRoot(oldRoot);
    ...
    private SlidingRootNavLayout createAndInitNewRoot(View oldRoot) {
        newRoot = new SlidingRootNavLayout(activity);
